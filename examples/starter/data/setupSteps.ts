...
export const setupSteps: SetupStep[] = [
  {
    ...
    description: "You'll need a Cloudflare API token and Account ID to use Workers AI with the Edgecraft connector.",
    instructions: [
...
# OPENAI_MODEL=gpt-4o-mini`,
  ...
  },
  {
    ...
    description: "Restart the dev server. In the popup header you can switch provider (Cloudflare/OpenAI). The app uses the Edgecraft API at `/api/ai/chat`.",
